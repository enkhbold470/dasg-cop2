<script lang="ts">
	...
	const electionDate = new Date('2025-03-13T00:00:00'); // Update with actual election date
...
<div class="rounded-lg bg-white/90 p-6 text-center shadow-lg backdrop-blur-sm">
	<h3 class="mb-4 text-2xl font-bold text-[#8B032C]">Election Day Countdown</h3>
